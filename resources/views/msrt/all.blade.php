                ...
                <ul class="service-list" style="    grid-template-columns: 1fr;">
                    ...
                    @if(isset($degrees))
                        <section class="testimonials">
                            ...
                            <h3 class="h3 testimonials-title">all Degree Inquiry</h3>
                                        ...
                                        <li class="testimonials-item">
                                            <div class="content-card" data-testimonials-item>
                                                ...
                                                <h4 class="h4 testimonials-item-title"
                                                    data-testimonials-title>{{$degree->fullName}}</h4>

                                                <div class="testimonials-text" data-testimonials-text>
                                                    <p>
                                                        Receive At
                                                        : {{jalali($degree->created_at)->format('Y/m/d H:i:s') }}
                                                    </p>
                                                    ...
                                                    @if($degree->status == "debt")
                                                        <h5 class="h5">Debt : {{$degree->debt}}</h5>
                                            ...
                                            <section class="testimonials-modal">
                                                ...
                                                <div class="modal-img-wrapper">
                                                    <figure class="modal-avatar-box">
                                                        <img src="{{asset('/assets/images/avatar-1.png')}}" width="80"
                                                             data-modal-img>
                                                    </figure>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <h4 class="h3 modal-title"
                                                        data-modal-title>{{$degree->FullName}}</h4>
                                                    ...
                                                    <div data-modal-text>
                                                        ...
                                                        <div style="grid-template-columns: 1fr  1fr">
                                                            <h5 class="h5"> student Number : {{$degree->stNumber}}</h5>
                                                            <h5 class="h5"> National code
                                                                : {{$degree->nationalCode}}</h5>
                                                            <h5 class="h5">Degree : {{$degree->grade}}</h5>
                                                            <h5 class="h5">major : {{$degree->major}}</h5>
                                                            <h5 class="h5">status : {{$degree->status}}</h5>
                                                        </div>
